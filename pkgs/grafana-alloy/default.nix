...
# Local override of `pkgs.grafana-alloy` pinned to v1.16.0.
#
# Reason for this override:
#   The nixpkgs-darwin rev currently locked in flake.lock ships
#   grafana-alloy 1.15.1, whose `collector/go.mod` pins `go-m1cpu v0.1.7`.
#   `go-m1cpu < v0.2.1` segfaults in init() on M3 Pro / M4 / M5 Apple Silicon
#   (see github.com/shoenig/go-m1cpu PR #27, PR #29).
#
let
  beylaVersion = "v3.9.5";
in
